...
def create_warrant_pdf(warrant_type, officer_name, complaint_person, complaint_address, offence,
    ...
    class WarrantPDF(FPDF):
        def header(self):
            # Add Logo
            self.image("legal_logo.png", 10, 8, 33)  # Adjust path and size accordingly
...
def main():
    ...
    # Add Logo and Title
    st.image("law.png", width=100)  # Add your logo
    ...
    st.markdown("---")
    st.markdown("<footer style='text-align: center;'>Generated by Petition Generator | 2025</footer>", unsafe_allow_html=True)
